...
namespace System.Text.Kdl.Serialization.Metadata
{
    ...
    // Every F# application ships with a copy of FSharp.Core, however it is not available statically to System.Text.Kdl.
    ...
    /// <summary>
    /// Proxy class used to access FSharp.Core metadata and reflection APIs that are not statically available to System.Text.Kdl.
    /// </summary>
    internal sealed class FSharpCoreReflectionProxy
    {
        /// <summary>
        /// The various categories of F# types that System.Text.Kdl supports.
        /// </summary>
