...
using FSharpKind = System.Text.Kdl.Serialization.Metadata.FSharpCoreReflectionProxy.FSharpKind;
...
namespace System.Text.Kdl.Serialization.Converters
{
    ...
    internal sealed class FSharpTypeConverterFactory : KdlConverterFactory
    {
        ...
        public override KdlConverter? CreateConverter(Type typeToConvert, KdlSerializerOptions options)
        {
            ...
            return (KdlConverter)Activator.CreateInstance(converterFactoryType, constructorArguments)!;
        }
    }
}
