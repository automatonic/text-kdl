...
namespace System.Text.Kdl.Serialization.Converters
{
    ...
    internal sealed class FSharpValueOptionConverter<TValueOption, TElement> : KdlConverter<TValueOption>
        where TValueOption : struct, IEquatable<TValueOption>
    {
        ...
        internal override bool OnTryRead(ref KdlReader reader, Type typeToConvert, KdlSerializerOptions options, scoped ref ReadStack state, out TValueOption value)
        {
        ...
        internal override bool OnTryWrite(KdlWriter writer, TValueOption value, KdlSerializerOptions options, ref WriteStack state)
        {
        ...
        public override void Write(KdlWriter writer, TValueOption value, KdlSerializerOptions options)
        {
            if (value.Equals(default))
            {
                // Write `ValueNone` values as null
        ...
        public override TValueOption Read(ref KdlReader reader, Type typeToConvert, KdlSerializerOptions options)
        {
