...
namespace System.Text.Kdl
{
    ...
    {
        /// <summary>
        /// Converts the provided value into a <see cref="KdlNode"/>.
        /// </summary>
        /// <typeparam name="TValue">The type of the value to serialize.</typeparam>
        /// <returns>A <see cref="KdlNode"/> representation of the KDL value.</returns>
        ...
        public static KdlNode? SerializeToNode<TValue>(TValue value, KdlSerializerOptions? options = null)
        {
        ...
        /// Converts the provided value into a <see cref="KdlNode"/>.
        /// </summary>
        /// <returns>A <see cref="KdlNode"/> representation of the value.</returns>
        /// <param name="value">The value to convert.</param>
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        [RequiresDynamicCode(SerializationRequiresDynamicCodeMessage)]
        public static KdlNode? SerializeToNode(object? value, Type inputType, KdlSerializerOptions? options = null)
        {
        ...
        /// </exception>
        public static KdlNode? SerializeToNode<TValue>(TValue value, KdlTypeInfo<TValue> jsonTypeInfo)
        {
        ...
        /// </exception>
        public static KdlNode? SerializeToNode(object? value, KdlTypeInfo jsonTypeInfo)
        {
            if (jsonTypeInfo is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(jsonTypeInfo));
        ...
        /// </exception>
        public static KdlNode? SerializeToNode(object? value, Type inputType, KdlSerializerContext context)
        {
            if (context is null)
            {
        ...
        private static KdlNode? WriteNode<TValue>(in TValue value, KdlTypeInfo<TValue> jsonTypeInfo)
        {
            ...
            try
            {
                ...
                return KdlNode.Parse(output.WrittenMemory.Span, options.GetNodeOptions(), options.GetDocumentOptions());
            }
            finally
            {
        ...
        private static KdlNode? WriteNodeAsObject(object? value, KdlTypeInfo jsonTypeInfo)
        {
            Debug.Assert(jsonTypeInfo.IsConfigured);
            KdlSerializerOptions options = jsonTypeInfo.Options;
