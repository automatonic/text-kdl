...
namespace System.Text.Kdl
{
    ...
    {
        /// <summary>
        /// Converts the <see cref="KdlNode"/> representing a single KDL value into a <typeparamref name="TValue"/>.
        /// </summary>
        ...
        /// <param name="node">The <see cref="KdlNode"/> to convert.</param>
        ...
        public static TValue? Deserialize<TValue>(this KdlNode? node, KdlSerializerOptions? options = null)
        {
        ...
        /// <summary>
        /// Converts the <see cref="KdlNode"/> representing a single KDL value into a <paramref name="returnType"/>.
        /// </summary>
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        [RequiresDynamicCode(SerializationRequiresDynamicCodeMessage)]
        public static object? Deserialize(this KdlNode? node, Type returnType, KdlSerializerOptions? options = null)
        {
        ...
        /// <typeparamref name="TValue" /> is not compatible with the KDL.
        /// </exception>
        public static TValue? Deserialize<TValue>(this KdlNode? node, KdlTypeInfo<TValue> jsonTypeInfo)
        {
        ...
        /// <summary>
        /// Converts the <see cref="KdlNode"/> representing a single KDL value into an instance specified by the <paramref name="jsonTypeInfo"/>.
        /// </summary>
        ...
        /// <paramref name="jsonTypeInfo"/> is <see langword="null"/>.
        /// </exception>
        public static object? Deserialize(this KdlNode? node, KdlTypeInfo jsonTypeInfo)
        {
            if (jsonTypeInfo is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(jsonTypeInfo));
        ...
        /// </exception>
        public static object? Deserialize(this KdlNode? node, Type returnType, KdlSerializerContext context)
        {
            if (returnType is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(returnType));
        ...
        private static TValue? ReadFromNode<TValue>(KdlNode? node, KdlTypeInfo<TValue> jsonTypeInfo)
        {
        ...
        private static object? ReadFromNodeAsObject(KdlNode? node, KdlTypeInfo jsonTypeInfo)
        {
            KdlSerializerOptions options = jsonTypeInfo.Options;
