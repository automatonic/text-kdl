...
namespace System.Text.Kdl
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="DateTimeOffset"/> value (as a KDL string) as part of a name/value pair of a KDL object.
        /// </summary>
        ...
        /// </remarks>
        public void WriteString(KdlEncodedText propertyName, DateTimeOffset value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="DateTimeOffset"/> value (as a KDL string) as part of a name/value pair of a KDL object.
        /// </summary>
        ...
        private void WriteStringMinimized(ReadOnlySpan<char> escapedPropertyName, DateTimeOffset value)
        {
            ...
            KdlWriterHelper.WriteDateTimeOffsetTrimmed(output.Slice(BytesPending), value, out int bytesWritten);
        ...
        internal void WritePropertyName(DateTimeOffset value)
        {
            ...
            KdlWriterHelper.WriteDateTimeOffsetTrimmed(buffer, value, out int bytesWritten);
