...
namespace System.Text.Kdl
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="decimal"/> value (as a KDL number) as part of a name/value pair of a KDL object.
        /// </summary>
        ...
        /// </remarks>
        public void WriteNumber(KdlEncodedText propertyName, decimal value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="decimal"/> value (as a KDL number) as part of a name/value pair of a KDL object.
        /// </summary>
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding) - KdlConstants.MaximumFormatDecimalLength - 4);

            // All ASCII, 2 quotes for property name, and 1 colon => escapedPropertyName.Length + KdlConstants.MaximumFormatDecimalLength + 3
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedPropertyName.Length * KdlConstants.MaxExpansionFactorWhileTranscoding) + KdlConstants.MaximumFormatDecimalLength + 4;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - KdlConstants.MaximumFormatDecimalLength - 4);

            int minRequired = escapedPropertyName.Length + KdlConstants.MaximumFormatDecimalLength + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<char> escapedPropertyName, decimal value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding) - indent - KdlConstants.MaximumFormatDecimalLength - 5 - _newLineLength);

            // All ASCII, 2 quotes for property name, 1 colon, and 1 space => escapedPropertyName.Length + KdlConstants.MaximumFormatDecimalLength + 4
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedPropertyName.Length * KdlConstants.MaxExpansionFactorWhileTranscoding) + KdlConstants.MaximumFormatDecimalLength + 5 + _newLineLength;
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, decimal value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - KdlConstants.MaximumFormatDecimalLength - 5 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + KdlConstants.MaximumFormatDecimalLength + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        {
            Span<byte> utf8PropertyName = stackalloc byte[KdlConstants.MaximumFormatDecimalLength];
