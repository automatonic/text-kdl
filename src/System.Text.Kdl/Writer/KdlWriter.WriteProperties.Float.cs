...
namespace System.Text.Kdl
{
    public sealed partial class KdlWriter
    {
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding) - KdlConstants.MaximumFormatSingleLength - 4);
            ...
            int maxRequired = (escapedPropertyName.Length * KdlConstants.MaxExpansionFactorWhileTranscoding) + KdlConstants.MaximumFormatSingleLength + 4;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - KdlConstants.MaximumFormatSingleLength - 4);

            int minRequired = escapedPropertyName.Length + KdlConstants.MaximumFormatSingleLength + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<char> escapedPropertyName, float value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding) - indent - KdlConstants.MaximumFormatSingleLength - 5 - _newLineLength);
            ...
            int maxRequired = indent + (escapedPropertyName.Length * KdlConstants.MaxExpansionFactorWhileTranscoding) + KdlConstants.MaximumFormatSingleLength + 5 + _newLineLength;
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, float value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - KdlConstants.MaximumFormatSingleLength - 5 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + KdlConstants.MaximumFormatSingleLength + 4; // 2 quotes for property name, 1 colon, and 1 space
