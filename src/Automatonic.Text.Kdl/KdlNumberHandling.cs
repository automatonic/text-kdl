namespace Automatonic.Text.Kdl.Serialization
{
    ...
    /// <remarks>
    /// The behavior of <see cref="WriteAsString"/> and <see cref="AllowNamedFloatingPointLiterals"/> is not defined by the KDL specification. Altering the default number handling can potentially produce KDL that cannot be parsed by other KDL implementations.
    /// </remarks>
    /// </summary>
    [Flags]
    ...
    {
        /// <summary>
        /// Numbers will only be read from <see cref="KdlTokenType.Number"/> tokens and will only be written as KDL numbers (without quotes).
        /// </summary>
        Strict = 0x0,
        ...
        /// <summary>
        /// Numbers will be written as KDL strings (with quotes), not as KDL numbers.
        /// <remarks>
        ...
        /// will be written as their corresponding KDL string representations.
        /// Strings that have escaped characters will be unescaped before reading.
        /// Leading or trailing trivia within the string token, including whitespace, is not allowed.
        /// <remarks>
        /// This behavior is not defined by the KDL specification. Altering the default number handling can potentially produce KDL that cannot be parsed by other KDL implementations.
