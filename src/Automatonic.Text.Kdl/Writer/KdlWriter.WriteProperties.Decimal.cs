...
namespace Automatonic.Text.Kdl
{
    public sealed partial class KdlWriter
    {
            ...
            Debug.Assert(
                escapedPropertyName.Length
                    < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding)
                        - KdlConstants.MaximumFormatDecimalLength
                        - 4
            );
        ...
        private void WriteNumberMinimized(ReadOnlySpan<byte> escapedPropertyName, decimal value)
        {
            Debug.Assert(
                escapedPropertyName.Length
                    < int.MaxValue - KdlConstants.MaximumFormatDecimalLength - 4
            );

            int minRequired =
                escapedPropertyName.Length + KdlConstants.MaximumFormatDecimalLength + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, decimal value)
        {
            ...
            int minRequired =
                indent + escapedPropertyName.Length + KdlConstants.MaximumFormatDecimalLength + 4; // 2 quotes for property name, 1 colon, and 1 space
