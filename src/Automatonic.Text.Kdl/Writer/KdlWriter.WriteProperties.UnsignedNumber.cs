...
namespace Automatonic.Text.Kdl
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="ulong"/> value (as a KDL number) as part of a name/value pair of a KDL object.
        /// </summary>
        ...
        /// </remarks>
        [CLSCompliant(false)]
        public void WriteNumber(KdlEncodedText propertyName, ulong value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="ulong"/> value (as a KDL number) as part of a name/value pair of a KDL object.
        /// </summary>
        ...
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="uint"/> value (as a KDL number) as part of a name/value pair of a KDL object.
        /// </summary>
        /// <param name="propertyName">The KDL-encoded name of the property to write.</param>
        /// <param name="value">The value to write.</param>
        /// <exception cref="InvalidOperationException">
        ...
        /// </remarks>
        [CLSCompliant(false)]
        public void WriteNumber(KdlEncodedText propertyName, uint value)
            => WriteNumber(propertyName, (ulong)value);

        /// <summary>
        /// Writes the property name and <see cref="uint"/> value (as a KDL number) as part of a name/value pair of a KDL object.
        /// </summary>
        /// <param name="propertyName">The name of the property to write.</param>
        /// <param name="value">The value to write.</param>
        /// <exception cref="ArgumentException">
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding) - KdlConstants.MaximumFormatUInt64Length - 4);

            // All ASCII, 2 quotes for property name, and 1 colon => escapedPropertyName.Length + KdlConstants.MaximumFormatUInt64Length + 3
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedPropertyName.Length * KdlConstants.MaxExpansionFactorWhileTranscoding) + KdlConstants.MaximumFormatUInt64Length + 4;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - KdlConstants.MaximumFormatUInt64Length - 4);

            int minRequired = escapedPropertyName.Length + KdlConstants.MaximumFormatUInt64Length + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<char> escapedPropertyName, ulong value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding) - indent - KdlConstants.MaximumFormatUInt64Length - 5 - _newLineLength);

            // All ASCII, 2 quotes for property name, 1 colon, and 1 space => escapedPropertyName.Length + KdlConstants.MaximumFormatUInt64Length + 4
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedPropertyName.Length * KdlConstants.MaxExpansionFactorWhileTranscoding) + KdlConstants.MaximumFormatUInt64Length + 5 + _newLineLength;
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, ulong value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - KdlConstants.MaximumFormatUInt64Length - 5 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + KdlConstants.MaximumFormatUInt64Length + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        {
            Span<byte> utf8PropertyName = stackalloc byte[KdlConstants.MaximumFormatUInt64Length];
