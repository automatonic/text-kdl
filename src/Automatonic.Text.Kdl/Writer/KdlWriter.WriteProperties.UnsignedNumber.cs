...
namespace Automatonic.Text.Kdl
{
    public sealed partial class KdlWriter
    {
            ...
            Debug.Assert(
                escapedPropertyName.Length
                    < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding)
                        - KdlConstants.MaximumFormatUInt64Length
                        - 4
            );
        ...
        private void WriteNumberMinimized(ReadOnlySpan<byte> escapedPropertyName, ulong value)
        {
            Debug.Assert(
                escapedPropertyName.Length
                    < int.MaxValue - KdlConstants.MaximumFormatUInt64Length - 4
            );

            int minRequired =
                escapedPropertyName.Length + KdlConstants.MaximumFormatUInt64Length + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, ulong value)
        {
            ...
            int minRequired =
                indent + escapedPropertyName.Length + KdlConstants.MaximumFormatUInt64Length + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        internal void WritePropertyName(uint value) => WritePropertyName((ulong)value);
