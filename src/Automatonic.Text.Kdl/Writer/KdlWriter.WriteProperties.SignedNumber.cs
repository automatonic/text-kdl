...
namespace Automatonic.Text.Kdl
{
    public sealed partial class KdlWriter
    {
            ...
            Debug.Assert(
                escapedPropertyName.Length
                    < (int.MaxValue / KdlConstants.MaxExpansionFactorWhileTranscoding)
                        - KdlConstants.MaximumFormatInt64Length
                        - 4
            );
        ...
        private void WriteNumberMinimized(ReadOnlySpan<byte> escapedPropertyName, long value)
        {
            Debug.Assert(
                escapedPropertyName.Length
                    < int.MaxValue - KdlConstants.MaximumFormatInt64Length - 4
            );

            int minRequired =
                escapedPropertyName.Length + KdlConstants.MaximumFormatInt64Length + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, long value)
        {
            ...
            int minRequired =
                indent + escapedPropertyName.Length + KdlConstants.MaximumFormatInt64Length + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        internal void WritePropertyName(int value) => WritePropertyName((long)value);
