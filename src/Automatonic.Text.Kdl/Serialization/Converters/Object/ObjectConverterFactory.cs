...
namespace Automatonic.Text.Kdl.Serialization.Converters
{
    ...
    internal sealed class ObjectConverterFactory(
        bool useDefaultConstructorInUnannotatedStructs = true
    ) : KdlConverterFactory
    {
        ...
        )
        {
            ...
            {
                ThrowHelper.ThrowInvalidOperationException_SerializationDuplicateTypeAttribute<KdlConstructorAttribute>(
                    typeToConvert
                );
            }
            ...
            else
            {
                ...
                if (parameterCount <= KdlConstants.UnboxedParameterCountThreshold)
                {
                    ...
                    Type[] typeArguments = new Type[
                        KdlConstants.UnboxedParameterCountThreshold + 1
                    ];
