namespace Automatonic.Text.Kdl.Serialization
{
    ...
    public abstract class ReferenceResolver
    {
        ...
        /// This method gets called when an $id metadata property from a KDL object is read.
        /// </summary>
        /// <param name="referenceId">The identifier of the respective KDL object or array.</param>
        /// <param name="value">The value of the respective CLR reference type object that results from parsing the KDL object.</param>
