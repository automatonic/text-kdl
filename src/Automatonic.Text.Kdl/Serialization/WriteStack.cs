...
namespace Automatonic.Text.Kdl
{
    ...
    internal struct WriteStack
    {
        ...
        /// <summary>
        /// Gets the nested KdlTypeInfo before resolving any polymorphic converters
        /// </summary>
        ...
        // Return a property path as a simple KDLPath using dot-notation when possible. When special characters are present, bracket-notation is used:
        // $.x.y.z
