...
{
    /// <summary>
    /// When placed on a property or field of type <see cref="Automatonic.Text.Kdl.Graph.KdlNode"/> or
    ...
    /// <see cref="object"/>, the type of object created will either be a <see cref="Automatonic.Text.Kdl.Graph.KdlElement"/> or a
    /// <see cref="KdlReadOnlyElement"/> depending on the value of <see cref="Automatonic.Text.Kdl.KdlSerializerOptions.UnknownTypeHandling"/>.
    ///
