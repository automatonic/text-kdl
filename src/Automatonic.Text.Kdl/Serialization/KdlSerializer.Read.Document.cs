...
namespace Automatonic.Text.Kdl
{
    public static partial class KdlSerializer
    {
        ...
        /// <typeparamref name="TValue" /> is not compatible with the KDL.
        /// </exception>
        public static TValue? Deserialize<TValue>(this KdlReadOnlyDocument document, KdlTypeInfo<TValue> jsonTypeInfo)
        {
            if (document is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(document));
        ...
        /// <summary>
        /// Converts the <see cref="KdlReadOnlyDocument"/> representing a single KDL value into an instance specified by the <paramref name="jsonTypeInfo"/>.
        /// </summary>
        /// <param name="document">The <see cref="KdlReadOnlyDocument"/> to convert.</param>
        /// <param name="jsonTypeInfo">Metadata about the type to convert.</param>
        ...
        /// <paramref name="jsonTypeInfo"/> is <see langword="null"/>.
        /// </exception>
        public static object? Deserialize(this KdlReadOnlyDocument document, KdlTypeInfo jsonTypeInfo)
        {
            if (document is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(document));
