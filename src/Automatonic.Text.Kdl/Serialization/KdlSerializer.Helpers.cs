...
namespace Automatonic.Text.Kdl
{
    public static partial class KdlSerializer
    {
        ...
        /// </summary>
        /// <remarks>
        /// The value of the property is backed by the "Automatonic.Text.Kdl.KdlSerializer.IsReflectionEnabledByDefault"
        /// <see cref="AppContext"/> setting and defaults to <see langword="true"/> if unset.
        /// </remarks>
        [FeatureSwitchDefinition("Automatonic.Text.Kdl.KdlSerializer.IsReflectionEnabledByDefault")]
