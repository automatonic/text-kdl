...
{
    /// <summary>
    /// Provides KDL serialization-related metadata about a constructor parameter.
    /// </summary>
    public abstract class KdlParameterInfo
    {
        ...
        ///
        /// This setting is in sync with the associated <see cref="KdlPropertyInfo.IsSetNullable"/> property.
        /// </remarks>
        ...
        internal KdlPropertyInfo MatchingProperty { get; }

        internal KdlConverter EffectiveConverter => MatchingProperty.EffectiveConverter;
        internal bool IgnoreNullTokensOnRead => MatchingProperty.IgnoreNullTokensOnRead;
        internal KdlSerializerOptions Options => MatchingProperty.Options;

        // The effective name of the parameter as UTF-8 bytes.
        internal byte[] KdlNameAsUtf8Bytes => MatchingProperty.NameAsUtf8Bytes;
        internal KdlNumberHandling? NumberHandling => MatchingProperty.EffectiveNumberHandling;
        internal KdlTypeInfo KdlTypeInfo => MatchingProperty.KdlTypeInfo;
