...
namespace Automatonic.Text.Kdl.Serialization.Metadata
{
    public abstract partial class KdlTypeInfo
    {
        ...
        internal ReadOnlySpan<KdlParameterInfo> ParameterCache
        {
            get
            {
        ...
        private KdlParameterInfo[]? _parameterCache;

        // All of the serializable properties on a POCO (minus the extension property).
        internal ReadOnlySpan<KdlPropertyInfo> PropertyCache
        {
            get
            {
        ...
        private Dictionary<string, KdlPropertyInfo>? _propertyIndex;

        /// <summary>
        /// Stores a cache of UTF-8 encoded property names and their associated KdlPropertyInfo, if available.
