...
namespace Automatonic.Text.Kdl.Serialization.Metadata
{
    ...
    // Every F# application ships with a copy of FSharp.Core, however it is not available statically to Automatonic.Text.Kdl.
    ...
    /// <summary>
    /// Proxy class used to access FSharp.Core metadata and reflection APIs that are not statically available to Automatonic.Text.Kdl.
    /// </summary>
    internal sealed class FSharpCoreReflectionProxy
    {
        /// <summary>
        /// The various categories of F# types that Automatonic.Text.Kdl supports.
        /// </summary>
        ...
        {
            foreach (Attribute attr in type.GetCustomAttributes(inherit: true).Cast<Attribute>())
            {
