...
namespace Automatonic.Text.Kdl.Serialization.Metadata
{
    public static partial class KdlMetadataServices
    {
        ...
        public static KdlConverter<bool> BooleanConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<byte[]?> ByteArrayConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<DateTime> DateTimeConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<DateTimeOffset> DateTimeOffsetConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<DateOnly> DateOnlyConverter =>
            s_dateOnlyConverter ??= new DateOnlyConverter();
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<decimal> DecimalConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<double> DoubleConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<short> Int16Converter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<long> Int64Converter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<Int128> Int128Converter =>
            s_int128Converter ??= new Int128Converter();
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<KdlReadOnlyElement> KdlReadOnlyElementConverter =>
            s_kdlReadOnlyElementConverter ??= new KdlReadOnlyElementConverter();
        private static KdlConverter<KdlReadOnlyElement>? s_kdlReadOnlyElementConverter;

        /// <summary>
        /// Returns a <see cref="KdlConverter{T}"/> instance that converts <see cref="KdlElement"/> values.
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<KdlElement?> KdlElementConverter =>
            s_kdlElementConverter ??= new KdlElementConverter();
        private static KdlConverter<KdlElement?>? s_kdlElementConverter;

        /// <summary>
        /// Returns a <see cref="KdlConverter{T}"/> instance that converts <see cref="KdlNode"/> values.
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<KdlNode?> KdlNodeConverter =>
            s_kdlNodeConverter ??= new KdlNodeConverter();
        private static KdlConverter<KdlNode?>? s_kdlNodeConverter;

        /// <summary>
        /// Returns a <see cref="KdlConverter{T}"/> instance that converts <see cref="KdlNode"/> values.
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<KdlValue?> KdlValueConverter =>
            s_kdlValueConverter ??= new KdlValueConverter();
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<KdlReadOnlyDocument?> KdlReadOnlyDocumentConverter =>
            s_kdlReadOnlyDocumentConverter ??= new KdlReadOnlyDocumentConverter();
        private static KdlConverter<KdlReadOnlyDocument?>? s_kdlReadOnlyDocumentConverter;

        /// <summary>
        /// Returns a <see cref="KdlConverter{T}"/> instance that converts <see cref="Memory{Byte}"/> values.
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<Memory<byte>> MemoryByteConverter =>
            s_memoryByteConverter ??= new MemoryByteConverter();
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<ReadOnlyMemory<byte>> ReadOnlyMemoryByteConverter =>
            s_readOnlyMemoryByteConverter ??= new ReadOnlyMemoryByteConverter();
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<object?> ObjectConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<float> SingleConverter =>
        ...
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        [CLSCompliant(false)]
        public static KdlConverter<sbyte> SByteConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<string?> StringConverter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<TimeSpan> TimeSpanConverter =>
            s_timeSpanConverter ??= new TimeSpanConverter();
        ...
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        [CLSCompliant(false)]
        public static KdlConverter<ushort> UInt16Converter =>
        ...
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        [CLSCompliant(false)]
        public static KdlConverter<uint> UInt32Converter =>
        ...
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        [CLSCompliant(false)]
        public static KdlConverter<ulong> UInt64Converter =>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<Version?> VersionConverter =>
        ...
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<T> GetEnumConverter<T>(KdlSerializerOptions options)
            where T : struct, Enum
        {
            if (options is null)
            {
            ...
            return EnumConverterFactory.Helpers.Create<T>(
        ...
        /// <returns>A <see cref="KdlConverter{T}"/> instance that converts <typeparamref name="T?"/> values</returns>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<T?> GetNullableConverter<T>(KdlTypeInfo<T> underlyingTypeInfo)
            where T : struct
        {
            ...
            KdlConverter<T> underlyingConverter = GetTypedConverter<T>(
                underlyingTypeInfo.Converter
            );
        ...
        /// <returns>A <see cref="KdlConverter{T}"/> instance that converts <typeparamref name="T?"/> values</returns>
        /// <remarks>This API is for use by the output of the Automatonic.Text.Kdl source generator and should not be called directly.</remarks>
        public static KdlConverter<T?> GetNullableConverter<T>(KdlSerializerOptions options)
            where T : struct
        {
            if (options is null)
            {
            ...
            KdlConverter<T> underlyingConverter = GetTypedConverter<T>(
                options.GetConverterInternal(typeof(T))
            );
        ...
        internal static KdlConverter<T> GetTypedConverter<T>(KdlConverter converter)
        {
            ...
            if (typedConverter == null)
            {
                throw new InvalidOperationException(
                    string.Format(SR.SerializationConverterNotCompatible, typedConverter, typeof(T))
                );
            }
