...
{
    /// <summary>
    /// Represents a UTF-8 encoded KDL property name and its associated <see cref="KdlPropertyInfo"/>, if available.
        ...
        : IEquatable<PropertyRef>
    {
        ...
        /// <summary>
        /// The <see cref="KdlPropertyInfo"/> associated with the property name, if available.
        /// </summary>
        public readonly KdlPropertyInfo? Info = info;
