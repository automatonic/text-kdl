...
{
    /// <summary>
    /// Defines the default, reflection-based KDL contract resolver used by Automatonic.Text.Kdl.
    /// </summary>
    /// <remarks>
            ...
            IBuiltInKdlTypeInfoResolver
    {
        ...
        public DefaultKdlTypeInfoResolver()
            : this(mutable: true) { }
        ...
        private sealed class ModifierCollection(DefaultKdlTypeInfoResolver resolver)
            : ConfigurationList<Action<KdlTypeInfo>>
        {
