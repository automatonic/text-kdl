namespace Automatonic.Text.Kdl.Serialization.Metadata
{
    ...
    public static class KdlTypeInfoResolver
    {
        ...
        /// It can also be used to fall back to <see cref="DefaultKdlTypeInfoResolver"/> wherever necessary.
        /// </remarks>
        public static IKdlTypeInfoResolver Combine(
            params ReadOnlySpan<IKdlTypeInfoResolver?> resolvers
        )
        {
        ...
        /// </remarks>
        public static IKdlTypeInfoResolver WithAddedModifier(
            this IKdlTypeInfoResolver resolver,
            Action<KdlTypeInfo> modifier
        )
        {
            if (resolver is null)
            {
    ...
    /// </summary>
    internal sealed class EmptyKdlTypeInfoResolver
