    ...
    internal sealed partial class ReflectionEmitCachingMemberAccessor() : MemberAccessor
    {
        ...
        public override Func<object>? CreateParameterlessConstructor(
            ...
            _cache.GetOrAdd(
                ...
                valueFactory: key =>
                    _sourceAccessor.CreateParameterlessConstructor(
                        key.declaringType,
        ...
        public override Func<object, TProperty> CreateFieldGetter<TProperty>(FieldInfo fieldInfo) =>
            _cache.GetOrAdd(
                ...
                valueFactory: key =>
                    _sourceAccessor.CreateFieldGetter<TProperty>((FieldInfo)key.member!)
            );
        ...
        public override Action<object, TProperty> CreateFieldSetter<TProperty>(
            ...
            _cache.GetOrAdd(
                ...
                valueFactory: key =>
                    _sourceAccessor.CreateFieldSetter<TProperty>((FieldInfo)key.member!)
            );
        ...
        > CreateImmutableDictionaryCreateRangeDelegate<TCollection, TKey, TValue>() =>
            _cache.GetOrAdd(
                ...
                valueFactory: _ =>
                    _sourceAccessor.CreateImmutableDictionaryCreateRangeDelegate<
                        TCollection,
                        TKey,
                        TValue
                    >()
        ...
        > CreateImmutableEnumerableCreateRangeDelegate<TCollection, TElement>() =>
            _cache.GetOrAdd(
                ...
                valueFactory: _ =>
                    _sourceAccessor.CreateImmutableEnumerableCreateRangeDelegate<
                        TCollection,
                        TElement
                    >()
            );
        ...
        public override Func<object[], T> CreateParameterizedConstructor<T>(
            ...
            _cache.GetOrAdd(
                ...
                valueFactory: key =>
                    _sourceAccessor.CreateParameterizedConstructor<T>((ConstructorInfo)key.member!)
            );
        ...
        >? CreateParameterizedConstructor<T, TArg0, TArg1, TArg2, TArg3>(
            ...
            _cache.GetOrAdd(
                key: (nameof(CreateParameterizedConstructor), typeof(T), constructor),
                valueFactory: key =>
                    _sourceAccessor.CreateParameterizedConstructor<T, TArg0, TArg1, TArg2, TArg3>(
                        (ConstructorInfo)key.member!
                    )
            );
        ...
        public override Func<object, TProperty> CreatePropertyGetter<TProperty>(
            ...
            _cache.GetOrAdd(
                ...
                valueFactory: key =>
                    _sourceAccessor.CreatePropertyGetter<TProperty>((PropertyInfo)key.member!)
            );
        ...
        public override Action<object, TProperty> CreatePropertySetter<TProperty>(
            ...
            _cache.GetOrAdd(
                ...
                valueFactory: key =>
                    _sourceAccessor.CreatePropertySetter<TProperty>((PropertyInfo)key.member!)
            );
    }
}
#endif
