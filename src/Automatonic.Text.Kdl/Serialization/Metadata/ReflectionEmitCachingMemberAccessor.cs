...
namespace Automatonic.Text.Kdl.Serialization.Metadata
{
    ...
    internal sealed partial class ReflectionEmitCachingMemberAccessor() : MemberAccessor
    {
        ...
        public override KdlTypeInfo.ParameterizedConstructorDelegate<T, TArg0, TArg1, TArg2, TArg3>? CreateParameterizedConstructor<T, TArg0, TArg1, TArg2, TArg3>(ConstructorInfo constructor) =>
            _cache.GetOrAdd(
                key: (nameof(CreateParameterizedConstructor), typeof(T), constructor),
