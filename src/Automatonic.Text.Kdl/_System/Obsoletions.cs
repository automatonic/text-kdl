...
namespace System
{
    internal static class Obsoletions
    {
        ...
        internal const string GlobalAssemblyCacheMessage =
        ...
        internal const string KdlSerializerOptionsIgnoreNullValuesMessage =
            "KdlSerializerOptions.IgnoreNullValues is obsolete. To ignore null values when serializing, set DefaultIgnoreCondition to KdlIgnoreCondition.WhenWritingNull.";
        internal const string KdlSerializerOptionsIgnoreNullValuesDiagId = "SYSLIB0020";
        ...
        internal const string RijndaelMessage =
        ...
        internal const string SuppressIldasmAttributeMessage =
        ...
        internal const string KdlSerializerOptionsAddContextMessage =
            "KdlSerializerOptions.AddContext is obsolete. To register a KdlSerializerContext, use either the TypeInfoResolver or TypeInfoResolverChain properties.";
        internal const string KdlSerializerOptionsAddContextDiagId = "SYSLIB0049";

        internal const string LegacyFormatterMessage =
        ...
        internal const string ThreadVolatileReadWriteMessage =
        ...
        internal const string ArmIntrinsicPerformsUnsignedOperationMessage =
        ...
        internal const string LoadFromHashAlgorithmMessage =
        ...
        internal const string X509CtorCertDataObsoleteMessage =
            "Loading certificate data through the constructor or Import is obsolete. Use X509CertificateLoader instead to load certificates.";
        internal const string X509CtorCertDataObsoleteDiagId = "SYSLIB0057";

        internal const string TlsCipherAlgorithmEnumsMessage =
        ...
        internal const string SystemEventsEventsThreadShutdownMessage =
