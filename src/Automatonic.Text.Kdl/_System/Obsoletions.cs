...
namespace System
{
    internal static class Obsoletions
    {
        ...
        internal const string KdlSerializerOptionsIgnoreNullValuesMessage = "KdlSerializerOptions.IgnoreNullValues is obsolete. To ignore null values when serializing, set DefaultIgnoreCondition to KdlIgnoreCondition.WhenWritingNull.";
        ...
        internal const string KdlSerializerOptionsAddContextMessage = "KdlSerializerOptions.AddContext is obsolete. To register a KdlSerializerContext, use either the TypeInfoResolver or TypeInfoResolverChain properties.";
